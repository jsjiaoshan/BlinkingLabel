...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A subclass on UILabel that provides a blin'
...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/jsjiaoshan/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jiaoshan' => '2977530037@qq.com' }
  s.source           = { :git => 'https://github.com/jsjiaoshan/BlinkingLabel.git', :tag => s.version.to_s }
